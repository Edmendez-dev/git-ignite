<div
  style="
    ...
    background:
      radial-gradient(
        circle at 84% 48%,
        rgba(48, 124, 255, 0.45) 0%,
        rgba(48, 124, 255, 0.2) 24%,
        rgba(48, 124, 255, 0) 46%
      ),
      radial-gradient(
        circle at center,
        #1a3556 0%,
  ...
  >
    <img
      style="
        ...
        max-height: 132px;
        object-fit: contain;
        filter: drop-shadow(-24px 18px 30px rgba(0, 0, 0, 0.45));
        ...
        box-sizing: border-box;
      "
      src="./assets/classic-theme/ignite-languages.svg"
      alt="GitIgnite Classic Languages"
    />
    <img
      style="
        position: absolute;
        ...
        box-sizing: border-box;
      "
      src="./assets/classic-theme/ignite-streak.svg"
      alt="GitIgnite Classic Streak"
    />
  </div>
</div>
